...
window.addEventListener("DOMContentLoaded", () => {
    ...
    function navigationToggle() {
        $(".navigationAnimation__toggler").toggleClass(
            "navigationAnimation__toggler__SCRIPT"
        );
        ...
        if (
            $(".navigationAnimation__toggler").hasClass(
                "navigationAnimation__toggler__SCRIPT"
            )
        ) {
            audio1.play();
    ...
    window.addEventListener("scroll", () => {
        ...
        // About section
            ...
            currentScroll >= $("#About").offset().top &&
            currentScroll < $("#Resume").offset().top
        ) {
            $(".hdrNav_Ancor").removeClass("hdrNav__Ancor_Script");
        ...
        // Resume section
            ...
            currentScroll >= $("#Resume").offset().top &&
            currentScroll < $("#works").offset().top
        ) {
            $(".hdrNav_Ancor").removeClass("hdrNav__Ancor_Script");
        ...
        // Works section
            ...
            currentScroll >= $("#works").offset().top &&
            currentScroll < $("#Reviews").offset().top
        ) {
            $(".hdrNav_Ancor").removeClass("hdrNav__Ancor_Script");
        ...
        // Reviews section
            ...
            currentScroll >= $("#Reviews").offset().top &&
            currentScroll < $("#jumpToContact").offset().top
        ) {
            $(".hdrNav_Ancor").removeClass("hdrNav__Ancor_Script");
    ...
    function personalVideoPlay() {
        ...
        $(".personalVideo__iframeWrap").removeClass(
            "personalVideo__iframeWrap__Script"
        );
        $(".personalVideo__placeHolder").removeClass(
            "personalVideo__placeHolder__Script"
        );

        var youtubeEmbedUrl =
            "https://www.youtube.com/embed/WG5ikvJ2TKA?si=OTwG3Pdx5F-y_FoE";
        $(".personalVideo__iframe").attr("src", youtubeEmbedUrl);
        $(".personalVideo__iframe").on("load", function() {
            $(".personalVideo__iframeWrap").addClass(
                "personalVideo__iframeWrap__Script"
            );
            $(".personalVideo__placeHolder").addClass(
                "personalVideo__placeHolder__Script"
            );
        });
    }
    ...
    function personalVideoRemove() {
        ...
        $(".personalVideo__container").removeClass(
            "personalVideo__container__Script"
        );
    ...
    function hireContainerHide() {
        ...
        $(".HireMe__container__inner").removeClass(
            "HireMe__container__inner__Script"
        );
    }
    ...
    function MakeReviewContainer_Show() {
        ...
        $(".MakeReviewContainer__Inner").addClass(
            "MakeReviewContainer__Inner__Script"
        );
    }
    ...
    function MakeReviewContainer_Hide() {
        ...
        $(".MakeReviewContainer__Inner").removeClass(
            "MakeReviewContainer__Inner__Script"
        );
    }
    ...
    var hire__form = document.getElementById("HireMe_form");
    async function handle__hireFormSubmit(event) {
        event.preventDefault();
        var data = new FormData(event.target);

        fetch("https://formspree.io/f/xvgppvnw", {
                method: "POST",
                body: data,
                headers: {
    ...
    hire__form.addEventListener("submit", handle__hireFormSubmit);
    ...
    async function handle__reviewFormSubmit(event) {
        event.preventDefault();
        var data = new FormData(event.target);
        fetch("https://formspree.io/f/xyzggbrz", {
                method: "POST",
                body: data,
                headers: {
                    Accept: "application/json",
    ...
    Review_form.addEventListener("submit", handle__reviewFormSubmit);
